      ...
      settings_t *settings, int *size)
{
   ...
   SETTING_PATH("video_shader_path1", settings->paths.video_shader_path1, false, NULL, true);
   SETTING_PATH("video_shader_path2", settings->paths.video_shader_path2, false, NULL, true);
   SETTING_PATH("video_shader_path3", settings->paths.video_shader_path3, false, NULL, true);
   SETTING_PATH("video_shader_path4", settings->paths.video_shader_path4, false, NULL, true);
...
//std::map<std::string, std::string> m_arrm;
