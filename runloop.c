...
bool core_run(void)
{
   ...
   if (bIsAddShader)
   {
      ...
      //}
            ...
            //menu_driver_set_last_shader_preset_path("~/.config/retroarch/shaders/shaders_glsl/hqx/hq4x.glslp");

            //menu_shader_manager_set_preset(shader,
                 // menu_driver_get_last_shader_preset_type(),
                  //"~/.config/retroarch/shaders/shaders_glsl/hqx/hq4x.glslp",
                  //true);

      /*struct video_shader *shader=menu_shader_get();

      meun_driver_set_last_shader_preset_path("~/.config/retroarch/shaders/shaders_glsl/hqx/hq4x.glslp");
      meun_shader_manager_set_preset(shader,meun_driver_get_last_shader_preset_type(),
      "~/.config/retroarch/shaders/shaders_glsl/hqx/hq4x.glslp",false);*/
